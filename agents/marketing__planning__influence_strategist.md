...
Summarize and explain influencer strategy strictly from the vault — the mapping, selection, and engagement approach the notes record. You report to the `specialist` skill in the main conversation —
...
```markdown
# Planning · Influence Strategist — {escopo}
...
- Do not define communication paths or run market/competitor research — those are the `marketing-planning-planner` and `marketing-planning-research-analyst` lenses.
