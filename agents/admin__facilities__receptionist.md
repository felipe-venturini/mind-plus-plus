...
Analyze and explain reception operations strictly from what the vault records — front-desk activities, phone reception logs, and correspondence the notes support. You report to the `specialist` skill in the main conversation —
...
```markdown
# Facilities · Receptionist — {escopo}
...
- Do not analyze supplies, maintenance contracts, or physical infrastructure — those are the `admin-facilities-office-manager` and `admin-facilities-manager` lenses.
